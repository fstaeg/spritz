...
variables = {
    ...
    "ptlj": {
        ...
        "axis": hist.axis.Variable([20,30,50,70,100,140,200,300,1000], name="ptlj"),
    ...
    "ptlj_btagloose": {
        ...
        "axis": hist.axis.Variable([20,30,50,70,100,140,200,300,1000], name="ptlj_btagloose"),
    ...
    "ptlj_btagmedium": {
        ...
        "axis": hist.axis.Variable([20,30,50,70,100,140,200,300,1000], name="ptlj_btagmedium"),
    ...
    "ptlj_btagtight": {
        ...
        "axis": hist.axis.Variable([20,30,50,70,100,140,200,300,1000], name="ptlj_btagtight"),
    ...
    "ptbj": {
        ...
        "axis": hist.axis.Variable([20,30,50,70,100,200,1000], name="ptbj"),
        "label": "$p_{T}^{b jet}$",
        "unit": "GeV",
        "xlog": True
    },
    "ptbj_btagloose": {
        ...
        "axis": hist.axis.Variable([20,30,50,70,100,200,1000], name="ptbj_btagloose"),
    ...
    "ptbj_btagmedium": {
        ...
        "axis": hist.axis.Variable([20,30,50,70,100,200,1000], name="ptbj_btagmedium"),
    ...
    "ptbj_btagtight": {
        ...
        "axis": hist.axis.Variable([20,30,50,70,100,200,1000], name="ptbj_btagtight"),
