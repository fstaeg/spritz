...
# 3D differential K-factor from DYTurbo N3LO+N3LL / MiNNLO GenDressed
# Generated by configs/dy-eft-genDressed/plot_vs_dyturbo.py
# Replace hocorr with this (or combine with NLOEW) once kfactor file is validated
hocorr_gendressed_3D = [{
        "module": "gendressed_ho_reweight",
        "file": f"{fw_path}/configs/dy-eft-genDressed/kfactor_N3LO_genDressed.root",
        "object": "kfactor_N3LO_genDressed",
        "name": "N3LO",
    },{
        "module": "lhe_ho_reweight",
        "file": "/eos/user/g/gboldrin/www/POWHEG_Z_EW/powheg_ew_ratio.root",
...
datasets = {
    ...
    "DYtt": {
        ...
        "task_weight": 8,
        "max_weight": 1e9,
        "ho_corrections": hocorr, # can apply it also to tau tau since it is lhe
        "subsamples": subsamples_jetflavour,
    },
    "ST_s-channel": {
        "files": "ST_s-channel",
...
colors["DYtt_light"] = extended_petroff[8]
colors["DYtt_c"] = cmap_pastel[4]
colors["DYtt_b"] = cmap_pastel[7]
...
nuisances = {
    ...
    "QCDscale": {
        ...
        "samples": ({ k: [f"QCDScale_{i}" for i in [0,1,3,4,5,7,8]] for k in ['Single Top', 'TT', 'WW'] }
            | { k: [(f"QCDScale_{2*i}", f"QCDScale_{i}") for i in [0,1,3,4,5,7,8]] for k in ['DYll_b', 'DYll_c', 'DYll_light', 'DYtt_b', 'DYtt_c', 'DYtt_light'] }),
        "is_theory_unc": True
    },
    "PDFweight": {
        "name": "PDFweight",
        "type": "shape",
        "kind": "square",
        "samples": { k: [f"PDFWeight_{i}" for i in range(101)] for k in ['DYll_b', 'DYll_c', 'DYll_light', 'DYtt_b', 'DYtt_c', 'DYtt_light', 'Single Top', 'TT', 'WW'] },
        "is_theory_unc": True
    },
    "alphaS": {
        "name": "alphaS",
        "type": "shape",
        "kind": "envelope",
        "samples": { k: [f"PDFWeight_{i}" for i in [101,102]] for k in ['DYll_b', 'DYll_c', 'DYll_light', 'DYtt_b', 'DYtt_c', 'DYtt_light'] },
        "is_theory_unc": True
    },
    "PSWeight": {
        "name": "PSWeight",
        "type": "shape",
        "kind": "envelope",
        "samples": { k: [f"PSWeight_{i}" for i in range(4)] for k in ['DYll_b', 'DYll_c', 'DYll_light', 'DYtt_b', 'DYtt_c', 'DYtt_light', 'Single Top', 'TT', 'WW', 'WZ', 'ZZ'] },
        "is_theory_unc": True
    },
}
